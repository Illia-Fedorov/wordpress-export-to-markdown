	...
	turndownService.addRule('images', {
		...
		replacement: function (content, node) {
			...
			if (node.getAttribute("alt") === "") {
				title = "Image needs a description"
			} else title = node.getAttribute("alt")
			const html = "{<image src =" + "'" + node.getAttribute("src") + "' " + "width =" + "'" + node.getAttribute("width") + "' " + "height =" + "'" + node.getAttribute("height") + "' " + "title =" + "'" + title + "'" + ">}"
			return html;
		}
	});
